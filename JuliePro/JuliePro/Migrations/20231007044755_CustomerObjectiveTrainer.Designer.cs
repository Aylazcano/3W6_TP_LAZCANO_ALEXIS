...
namespace JuliePro.Migrations
{
    ...
    [Migration("20231007044755_CustomerObjectiveTrainer")]
    partial class CustomerObjectiveTrainer
    {
            ...
            modelBuilder.Entity("JuliePro.Models.Objective", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            AchievedDate = new DateTime(2023, 4, 7, 0, 47, 55, 663, DateTimeKind.Local).AddTicks(8332),
                            CustomerId = 1,
                            DistanceKm = 30.0,
                            LostWeightKg = 5.0,
                            Name = "Cardio"
                        ...
                        {
                            Id = 5,
                            AchievedDate = new DateTime(2023, 7, 7, 0, 47, 55, 663, DateTimeKind.Local).AddTicks(8364),
                            CustomerId = 3,
                            DistanceKm = 45.0,
                            LostWeightKg = 8.0,
                            Name = "Maigrir"
                        ...
                        {
                            Id = 6,
                            AchievedDate = new DateTime(2023, 8, 7, 0, 47, 55, 663, DateTimeKind.Local).AddTicks(8366),
                            CustomerId = 3,
                            DistanceKm = 20.0,
                            LostWeightKg = 7.0,
                            Name = "Tonus"
